...
public class DriveTrain2 extends LinearOpMode {
    ...
    private void runSlides(double pos, double power) {
        double TICKS_PER_MOTOR_REV = 537.6;
        // countable events per revolution for output shaft, THIS NUMBER CHANGES
        // DEPENDING ON THE TYPE OF MOTOR. VISIT SPECIFICATIONS ON THE WEBSITE THE TEAM
        // GOT THE MOTOR FROM.
        double DRIVE_GEAR_REDUCTION = 1.0;
     ...
     *
     * @param Strafe  is the first double X value which represents how the base
     *                should strafe
     * @param Forward is the only double Y value which represents how the base
     *                should drive forward
     *                //* @param Turn is the second double X value which represents
     *                how the base should turn
     */
